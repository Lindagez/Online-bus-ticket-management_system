      ...
      <div className="grid grid-cols-5 gap-5">
        ...
        <div className="space-y-7">
          ...
          <ul className="space-y-2 text-neutral-600 dark:text-neutral-500 text-base font-normal">
            <li>
              <Link to="#" className='hover:text-green-700 ease-in-out duration-300'>About Us</Link>
            </li>
            <li>
              <Link to="#" className='hover:text-green-700 ease-in-out duration-300'>Contact Us</Link>
            </li>
            <li>
              <Link to="#" className='hover:text-green-700 ease-in-out duration-300'>Privacy Policy</Link>
            </li>
            <li>
              <Link to="#" className='hover:text-green-700 ease-in-out duration-300'>Terms and Conditions</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-7">
          ...
          <ul className="space-y-2 text-neutral-600 dark:text-neutral-500 text-base font-normal">
            <li>
              <Link to="#" className='hover:text-green-700 ease-in-out duration-300'>Safety Guarantee</Link>
            </li>
            <li>
              <Link to="#" className='hover:text-green-700 ease-in-out duration-300'>FAQ & Support</Link>
            </li>
          </ul>
        </div>
